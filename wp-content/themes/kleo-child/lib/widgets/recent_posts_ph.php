...
class Kleo_Recent_Posts_widget_ph extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 
			'description' => __( 'Recent posts with thumbnails widget Phasionate.', 'kleo_framework' ) 
		);
		parent::__construct( 'kleo_recent_posts_phasionate', __('(Phasionate) Recent posts Phasionate','kleo_framework'), $widget_ops );
	}
					...
					<li class="news-content-ph">
						<a class="news-link" href="<?php the_permalink(); ?>">
                            ...
                            <?php elseif ( $thumb == 2 ) : /* Display post thumbnail */ ?>
                                ...
                                <span class="news-headline-ph"><?php the_title(); ?></span>
								<span class="news-excerpt-ph"><small><?php the_excerpt();?></small></span>
 ...
 * @since 1.0
 */
add_action( 'widgets_init', create_function( '', 'register_widget( "Kleo_Recent_Posts_widget_ph" );' ) );
