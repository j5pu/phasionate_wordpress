...
if (!function_exists('kleo_woo_get_mini_cart')) {
	function kleo_woo_get_mini_cart( $just_inner = false ) {
		...
		if ( $cart_count != "0" ) {
			...
			$cart_output .= '<div class="minicart-header">' . __('kleo child.','kleo_framework') . '</div>';                                 
			...
			$cart_output .= '<a class="btn btn-default kleo-go-shop" href="'.esc_url( $shop_page_url ).'"><span class="text">'.__('kleo child', 'kleo_framework').'</span></a>';
...
if (!function_exists('kleo_checkout_steps')) {
	...
	?>
		...
		<div class="checkout-steps">
			<span class="step-cart"><a href="<?php echo WC()->cart->get_cart_url(); ?>"><?php _e('Kelo child', 'kleo_framework'); ?></a></span>   
				<i class="icon icon-angle-right"></i>    
				<span class="step-checkout"><?php _e('Revisar detalles', 'kleo_framework'); ?></span>  
				<i class="icon icon-angle-right"></i>  
