...
?>
    ...
    <div class="boxContCollections">
        <div class="boxCollection">
            <h2><a href="<?php bloginfo('wpurl'); ?>/phetnia">Phetnia</a></h2>
            <a href="<?php bloginfo('wpurl'); ?>/phetnia"><img class="i" src="<?php bloginfo('wpurl'); ?>/wp-content/themes/kleo-child/assets/img/photography/003.jpg" /></a>
