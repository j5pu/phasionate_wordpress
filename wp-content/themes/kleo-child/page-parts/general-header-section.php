        ...
        <div class="container">
			...
			<div class="submenu-shop">
				<ul>
					...
					<li><a id="enlace-ropa-bogadia" href="<?php bloginfo('wpurl'); ?>/ropa-bogadia">productos</a></li>
					<li><a id="enlace-ropa-bogadia" href="<?php bloginfo('wpurl'); ?>/por-que-bogadia">¿Por qué Bogadia?</a></li>
				</ul>
			</div>
			<?php
			}
