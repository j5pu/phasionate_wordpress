<?php
	...
	<div id="pmpro_account">		
		...
		<div id="pmpro_account-profile" class="pmpro_box">	
			...
			<p>
				<a href="<?php if (function_exists('bp_is_active')) echo bp_loggedin_user_domain().'profile/edit/'; else echo admin_url('profile.php')?>""><?php _e("Edit Profile", "pmpro");?></a> |
				<a href="<?php if (function_exists('bp_is_active')) echo bp_loggedin_user_domain().'settings/'; else echo admin_url('profile.php')?>"><?php _ex("Change Password", "As in 'change password'.", "pmpro");?></a>
			</p>
