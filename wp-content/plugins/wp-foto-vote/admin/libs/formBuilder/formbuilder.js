	...
	BuilderView = (function (_super) {
		...
		BuilderView.prototype.saveForm = function (e) {
			...
			payload = JSON.stringify({
				...
				//submit: Formbuilder.submitField.toJSON()
			});
			if (Formbuilder.options.HTTP_ENDPOINT && Formbuilder.options.HTTP_SAVE_ACTION) {
		...
		BuilderView.prototype.doAjaxSave = function (payload) {
            if (Formbuilder.options.HTTP_ENDPOINT && Formbuilder.options.HTTP_SAVE_ACTION) {
                var _this = this;
                return $.ajax({
                    url: Formbuilder.options.HTTP_ENDPOINT + '=' + Formbuilder.options.HTTP_SAVE_ACTION,
                    ...
                    success: function (data) {
                        jQuery.growl.notice({ message: "Form fields Saved!" });
        ...
        BuilderView.prototype.restoreForm = function (e) {
            if ( !confirm('Are you sure to restore Default form? This will break all you changes!')  ) {
                return;
            }

            if (Formbuilder.options.HTTP_ENDPOINT && Formbuilder.options.HTTP_RESET_ACTION) {
                var _this = this;
                return $.ajax({
                    url: Formbuilder.options.HTTP_ENDPOINT + '=' + Formbuilder.options.HTTP_RESET_ACTION,
                    type: Formbuilder.options.HTTP_METHOD,
                    processData: false,  // tell jQuery not to process the data
                    contentType: false,   // tell jQuery not to set contentType
                    success: function (data) {
                        data = jQuery.parseJSON( FvLib.parseJson(data) );
                        fb = new Formbuilder({
                            selector: '.fb-main',
                            bootstrapData: data.fields
                        });
                        jQuery.growl.notice({ message: "Default form restored!" });
                    }
                });
            }
        };
...
*/
(function () {
	Formbuilder.registerField('checkbox_multi', {
		order: 10,
...
(function () {
	Formbuilder.registerField('email', {
		...
		edit: "<%= Formbuilder.templates['edit/default_value']() %>\n<%= Formbuilder.templates['edit/placeholder']() %>\n",
...
(function () {
	Formbuilder.registerField('textarea', {
		order: 5,
		view: "<textarea class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' placeholder='<%= rf.get(Formbuilder.options.mappings.PLACEHOLDER) %>'></textarea>",
...
(function () {
	Formbuilder.registerField('section_break', {
		...
		view: "<label class='section-name'><%= rf.get(Formbuilder.options.mappings.LABEL) %></label>\n" +
			  "<span class='help-block'><%= rf.get(Formbuilder.options.mappings.DESCRIPTION) %></span><%= Formbuilder.templates['view/duplicate_remove']() %>",
...
(function () {
	Formbuilder.registerField('file', {
		order: 0,
		view: "<label class='section-name'><span class='typcn typcn-document-add'></span> " +
		    ...
		    edit: "<div class='fb-edit-section-header'>Label</div>\n" +
                ...
                "<div class='fb-edit-section-header'>Input `photo name` placeholder:</div>\n<input type='input' data-rv-checked='model.<%= Formbuilder.options.mappings.PLACEHOLDER %>' value='Enter photo name'/>" +
...
(function () {
	Formbuilder.registerField('submit', {
		...
		edit: "",
		//type: 'submit',
		addButton: "<span class=\"symbol\"><span class=\"typcn typcn-document-add\"></span></span> Button"
	});
...
this["Formbuilder"]["templates"]["edit/base"] = function (obj) {
	...
	with (obj) {
		if ( rf.attributes.field_type != 'submit' ) {
			__p +=
			...
			__p += ((__t = ( Formbuilder.templates['edit/submit']() )) == null ? '' : __t) +
					'\n' +
				  	((__t = ( Formbuilder.fields[rf.get(Formbuilder.options.mappings.FIELD_TYPE)].edit({rf: rf}) )) == null ? '' : __t) +
				  	'\n';
...
this["Formbuilder"]["templates"]["edit/submit"] = function (obj) {
	...
	with (obj) {
		__p +=
			  "<div class='fb-edit-section-header'>Button text</div>\n" +
			  "<input type='text' data-rv-input='model." + Formbuilder.options.mappings.LABEL + "' />" +
				'\n' +
				'<div class=\'fb-edit-section-header\'>Icon</div>\n<select data-rv-value="model.' +
			  		((__t = ( Formbuilder.options.mappings.ICON )) == null ? '' : __t) +
				'">\n  <option value="spinner" class="fvicon fvicon-spinner">Icon 1</option>\n  ' +
					'<option value="spinner2" class="fvicon fvicon-spinner2">Icon 2</option>\n  ' +
				'</select>\n';
				;
...
this["Formbuilder"]["templates"]["edit/common"] = function (obj) {
	...
	with (obj) {
		__p += '<div class=\'fb-edit-section-header\'>Label</div>\n\n<div class=\'fb-common-wrapper\'>\n  <div class=\'fb-label-description\'>\n    ' +
			  ...
			  '\n  </div>\n  <div class=\'fb-clear\'></div>\n' +
			  '\n  </div>\n  <div class=\'fb-common-save_to\'>\n    ' +
			  ((__t = ( Formbuilder.templates['edit/save_to']() )) == null ? '' : __t) +
			  '\n  </div>\n  <div class=\'fb-clear\'></div>\n' +
			  '</div>\n';
...
this["Formbuilder"]["templates"]["edit/options"] = function (obj) {
	...
	with (obj) {
		...
		if (typeof includeOther !== 'undefined' && false) {
			;
			__p += '\n  <label>\n    <input type=\'checkbox\' data-rv-checked=\'model.' +
...
// where save field data
this["Formbuilder"]["templates"]["edit/save_to"] = function (obj) {
	obj || (obj = {});
	var __t, __p = '', __e = _.escape;
	with (obj) {
...
// field default data
this["Formbuilder"]["templates"]["edit/default_value"] = function (obj) {
	obj || (obj = {});
	var __t, __p = '', __e = _.escape;
	with (obj) {
...
/*
this["Formbuilder"]["templates"]["partials/submit_field"] = function (obj) {
	obj || (obj = {});
	var __t, __p = '', __e = _.escape;
	with (obj) {
		__p += '<div class=\'fb-tab-pane\' id=\'submitField\'>\n  ' +
			  	'<div class=\'fb-submit-field-wrapper\'>' +
			  	'</div>\n' +
			  '</div>\n';
	...
	with (obj) {
		__p += '<div class=\'fb-left\'>\n  ' +
			      '<ul class=\'fb-tabs\'>\n    ' +
			  		...
			  		//'<li><a data-target=\'#submitField\'>Submit opt.</a></li>\n  ' +
			      '</ul>\n\n  ' +
			  ...
			  '\n    ' +
			  //((__t = ( Formbuilder.templates['partials/submit_field']() )) == null ? '' : __t) +
			  '\n  </div>\n</div>';
...
this["Formbuilder"]["templates"]["partials/save_button"] = function (obj) {
	...
	with (obj) {
		__p += '<div class=\'fb-save-wrapper\'>\n  ' +
            ...
            ((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
            '\'>' + Formbuilder.options.dict.RESTORE_DEFAULT + '</button>\n' +
            '</div>';
...
this["Formbuilder"]["templates"]["view/base"] = function (obj) {
	...
	with (obj) {
		if ( rf.attributes.field_type != 'submit' ) {
			...
			__p += ((__t = ( Formbuilder.templates['view/submit']({rf: rf}) )) == null ? '' : __t) + '\n';
		}
