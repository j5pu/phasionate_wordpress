                ...
                <div class="pure-control-group">
                    <div class="pure-g">
                        <div class="pure-u-1">
                            ...
                            <small><?php _e('(need, only if you uses contest_list shortcode)', 'fv') ?></small>
                        </div>
                        <div class="pure-u-1">
                            ...
                            <input type="text" id="fv_cover_image" name="fv_cover_image" value="<?php echo $contest->cover_image ?>">
