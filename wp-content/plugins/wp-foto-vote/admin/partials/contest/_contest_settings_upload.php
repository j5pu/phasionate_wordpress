        ...
        <div class="inside">
            <div id="sv_wrapper" class="b-wrap">
                ...
                <div class="form-group">
                    ...
                    <select id="moderation_type" name="moderation_type" class="pure-input">
                ...
                <div class="row">
                        <div class="form-group col-sm-12">
                            <span id="timestamp">
                                <?php echo __('Upload date start', 'fv'); ?>
                                    <input type="text" class="datetime" id="upload_date_start" name="upload_date_start" value="<?php echo ($action == 'add') ? date("Y-m-d H:i:s", time()) : $contest->upload_date_start ?>">
                                <small><?php echo __('year-month-day h:m:s', 'fv') ?></small>
                            </span>
                        </div>

                        <div class="form-group col-sm-12">
                            <span id="timestamp"><?php echo __('Upload date finish', 'fv'); ?>
                                    <?php fv_get_tooltip_code(__('When time end, upload from will be hidden', 'fv')) ?>
                                    <input type="text" class="datetime" id="upload_date_finish" name="upload_date_finish" value="<?php echo ($action == 'add') ? date("Y-m-d H:i:s", time() + 1209600) : $contest->upload_date_finish ?>">
                                <small><?php echo __('year-month-day h:m:s', 'fv') ?></small>
                            </span>
                        </div>
                </div>
