...
class Fv_Options_Framework_Media_Uploader {
	...
	function optionsframework_media_scripts( $hook ) {
		...
		$menu = Fv_Options_Framework_Admin::menu_settings();
		...
		wp_register_script( 'of-media-uploader', plugin_dir_url( dirname(__FILE__) ) .'js/media-uploader.js', array( 'jquery' ), Fv_Options_Framework::VERSION );
