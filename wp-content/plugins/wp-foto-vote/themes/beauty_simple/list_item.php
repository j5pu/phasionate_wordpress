...
<div class="sv_unit contest-block" style="width: <?php echo get_option('fotov-block-width', FV_CONTEST_BLOCK_WIDTH) ; ?>px;">
	<div align="center">
            <a name="photo-<?php echo $id?>" data-id="<?php echo $id; ?>" class="fv_lightbox nolightbox noLightbox" rel="fw" href="<?php echo $image_full ?>" title="<?php echo htmlspecialchars(stripslashes($name)) ?>">
                <?php
                if ( $leaders ) {
