...
<div id="fv_constest_item">
    ...
    <div class="fv_photo" style="width: <?php echo $image[1] + 10 ?>px;">
        <div class="fv_photo_votes">
            <a href="#" onclick="sv_vote(<?php echo $contestant->id ?>); return false;">
                <?php if ($hide_votes == false): ?>
                    <i class="fvicon-heart3"></i> <span
                        class="sv_votes_<?php echo $contestant->id ?>"><?php echo $contestant->votes_count ?></span>
                <?php else: ?>
        ...
        <?php if (!empty($next_id)): ?>
            <div class="fv_next fv_nav">
                <a href="<?php echo $page_url . '=' . $next_id ?>" title="<?php _e('Next', 'fv') ?>">
        ...
        <?php if (!empty($prev_id)): ?>
            <div class="fv_prev fv_nav">
                <a href="<?php echo $page_url . '=' . $prev_id ?>" title="<?php _e('Previous', 'fv') ?>">
    ...
    <div class="fv_social">
        ...
        <div class="fv_social_icons">
            ...
            <?php endif; ?>
            <img class="snegovik" src="<?php echo $theme_imgs_url; ?>snegovik.png"/>
        </div>
    </div>
