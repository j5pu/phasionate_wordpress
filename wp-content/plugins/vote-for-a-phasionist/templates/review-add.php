...
<div class="um-reviews-item">
	...
	<div class="um-reviews-post review-new">
			...
			<span class="um-reviews-avg" data-number="1" data-score="0"></span>
	...
	<div class="um-reviews-post review-form">
		...
		<form class="um-reviews-form" action="" method="post">
			...
			<span class="um-reviews-rate" data-key="rating" data-number="1" data-score="0"></span>
			...
			<span class="um-reviews-send"><input type="submit" value="<?php _e('¡Vótame!','um-reviews'); ?>" class="um-button" /></span>
