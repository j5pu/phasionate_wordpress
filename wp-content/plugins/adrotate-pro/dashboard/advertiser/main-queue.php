...
<h3><?php _e('Queued and Erroneous Ads', 'adrotate-pro'); ?></h3>
<p><em><?php _e('Ads listed here are queued for review, rejected by a reviewer or have a configuration error.', 'adrotate-pro'); ?></em></p>
...
<?php
	foreach($queuebanners as $ad) {
	    ...
	    <tr id='banner-<?php echo $ad['id']; ?>' class='<?php echo $class.$errorclass; ?>'>
			...
			<td>
				<strong><a class="row-title" href="<?php echo admin_url('/admin.php?page=adrotate-advertiser&view=edit&ad='.$ad['id']);?>" title="<?php _e('Edit', 'adrotate-pro'); ?>"><?php echo stripslashes(html_entity_decode($ad['title']));?></a></strong>
