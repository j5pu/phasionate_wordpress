...
------------------------------------------------------------------------------------ */
?>
<h3><?php _e('Manage Schedules', 'adrotate-pro'); ?></h3>
...
<form name="banners" id="post" method="post" action="admin.php?page=adrotate-schedules">
	...
	<table class="widefat tablesorter manage-schedules-main" style="margin-top: .5em">
		...
		<tr>
	        ...
	        <th width="4%"><center><?php _e('Ads', 'adrotate-pro'); ?></center></th>
	...
	if($schedules) {
		...
		<tr id='no-schedules'>
			...
			<td colspan="<?php echo ($adrotate_config['stats'] == 1) ? '7' : '5'; ?>"><em><?php _e('No schedules created yet!', 'adrotate-pro'); ?></em></td>
		</tr>
	<?php } ?>
	</tbody>
</table>
