...
function adrotate_prepare_advertiser_report($user, $ads) {
	...
	if($ads) {
		...
		if(empty($stats['thebest'])) $stats['thebest'] = array('title' => __('Not found', 'adrotate-pro'), 'clicks' => 0);
		if(empty($stats['theworst'])) $stats['theworst'] = array('title' => __('Not found', 'adrotate-pro'), 'clicks' => 0);
