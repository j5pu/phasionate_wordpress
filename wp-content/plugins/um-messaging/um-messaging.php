...
*/
	...
	define('um_messaging_requires', '1.2.97');
	...
	***/
	...
	function um_messaging_plugin_updater() {
		if ( !function_exists( 'um_get_option' ) ) return;
		$item_key = 'um_messaging_license_key';
		$item_status = 'um_messaging_license_status';
		$product = 'Private Messages';
	...
	add_action( 'admin_init', 'um_messaging_plugin_updater', 0 );
	...
	add_filter('redux/options/um_options/compiler', 'um_messaging_license_status', 10, 3);
	function um_messaging_license_status($options, $css, $changed_values) {
		if ( !function_exists( 'um_get_option' ) ) return;
		$item_key = 'um_messaging_license_key';
		$item_status = 'um_messaging_license_status';
		$product = 'Private Messages';
